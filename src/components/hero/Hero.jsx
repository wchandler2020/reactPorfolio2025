        ...
        <div className="flex flex-wrap">
            <div className="w-full lg:w-1/2">
                <div className="flex flex-col items-center lg:items-start">
                    ...
                    <motion.p variants={container(1)} initial='hidden' animate='visible' className='my-4 max-w-xl py-6 font-light tracking-tighter'>View My Full Resume<p style={{lineHeight: 1.5, fontSize: 17, letterSpacing: .2}} ></p> </motion.p>
                </div>
            </div>
